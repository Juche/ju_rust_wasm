import * as wasm from './ju_rust_wasm_bg.wasm';
...
export class Universe {
    ...
    */
    is_cell_alive(row, column) {
        const ret = wasm.universe_is_cell_alive(this.ptr, row, column);
        return ret !== 0;
    }
    /**
    * @param {number} row
    ...
    */
    live_neighbor_count(row, column) {
        const ret = wasm.universe_live_neighbor_count(this.ptr, row, column);
        return ret;
    }
    /**
    */
